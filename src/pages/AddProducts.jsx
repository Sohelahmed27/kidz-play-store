...
const AddProducts = () => {
  ...
  const onSubmit = (data) => {
    ...
    fetch("https://kids-zone-server-murex.vercel.app/addToy", {
      method: "POST",
  ...
  return (
    <div className="bg-[#11468F]">
      <h1 className="text-center text-3xl font-bold text-white p-10">
        Add Toys
      </h1>
      <div>
        <form
          onSubmit={handleSubmit(onSubmit)}
          className="max-w-md mx-auto border border-solid border-blue-600 shadow-md rounded-lg p-10 bg-teal-500"
        >
          <div className="mb-4">
            <label htmlFor="pictureUrl" className="block mb-1 font-bold">
              Picture URL
            </label>
            <input
              type="text"
